          ...
          <div class="row justify-content-end">
            <div class="col-lg-8">
              ...
              <div class="section-title mb-40">
                <h1>{{ $current_location->title }}</h1>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ URL('/') }}">Home</a></li>
                    <!-- <li class="breadcrumb-item"><a href="{{ URL('/faqs') }}">FAQs</a></li> -->
                    <li class="breadcrumb-item active" aria-current="page">{{ $current_location->title }}</li>
                  </ol>
                </nav>
              </div>
            ...
            <aside class="aside col-lg-3 order-lg-1">
              <ul class="nostyle faq-nav">
                ...
                <li class="@if( $faq_location->id == $current_location->id ) active @endif">
                  ...
                  <a href="{{ URL('/faq/location/'.$faq_location->id) }}">{{ $faq_location->title }}</a>
                </li>
                @endforeach
